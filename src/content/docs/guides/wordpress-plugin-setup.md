...
Notificator Companion works in dashboard-only mode immediately after activation. An API key is optional and is needed only for mobile push and MQTT.

## Install the plugin

1. In WordPress Admin, go to **Plugins → Add New → Upload Plugin**.
2. Upload `notificator-companion.zip` and activate it.
3. Open **Notificator Companion → Overview**.

## Discover site events

1. Select **Scan** from Getting started or open **Tools → Scan plugins**.
...
Under Settings and Tools you can:
...
- export or import notifications;
